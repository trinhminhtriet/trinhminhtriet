...
- To apply for the position of **Senior Golang Developer**.
...
- **Programming Languages:** Golang, Java, Python, PHP, Bash.
...
- **Role:** Technical Lead
- **Technologies Used:** Golang, Aurora, Azure Active Directory, GitHub Actions, Terraform, Docker, ECS, SQS, SNS, SES, S3, Lambda, CloudFront, CloudWatch, ReactJS.
- **Responsibilities:**
- **Outcome:**
...
- **Role:** Technical Lead
- **Technologies Used:** Golang, Python, Docker, Terraform, AWS Lambda.
- **Responsibilities:**
...
- **Role:** Technical Lead
- **Technologies Used:** Golang, Aurora, GitHub Actions, Terraform, Docker, ECS, SQS, Lambda, S3, CloudFront, Route53, NewRelic.
- **Responsibilities:**

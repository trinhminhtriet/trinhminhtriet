...
- To apply for the position of **Senior Backend Engineer**.
...
- Handon experience in developing and maintaining applications.
...
- **Programming Languages:** Typescript, Javascript, Python, Golang, PHP, Bash.
...
- **Role:** Technical Lead
- **Technologies Used:** Typescript, NestJS, Aurora, Azure Active Directory, GitHub Actions, Terraform, Docker, ECS, SQS, SNS, SES, S3, Lambda, CloudFront, CloudWatch.
- **Responsibilities:**
...
- **Role:** Technical Lead
- **Technologies Used:** Typescript, NestJS, Python, Docker, Terraform, AWS Lambda.
- **Responsibilities:**
  - Developed and maintained web applications using PHP and related technologies.
...
- **Role:** Technical Lead
- **Technologies Used:** Golang, Typescript, NestJS, Aurora, GitHub Actions, Terraform, Docker, ECS, SQS, Lambda, S3, CloudFront, Route53, NewRelic.
- **Responsibilities:**
...
- **Technologies Used:** Typescript, NestJS, PHP, Moodle, MySQL, EC2, RDS, S3, CloudFront.
- **Responsibilities:**
...
- **Technologies Used:** Typescript, NestJS, MySQL, CentOS
- **Responsibilities:**
